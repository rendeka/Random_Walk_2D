#define N 40000	//number of random walks
#define n 132000	//length of each walk !WARNING! for task_1 and task_2 must be satisfied the condition: n > 2^maxPowerOftwo (Note: 2^15 = 32768)
...
int task = 3;	//task == 1 simple walk				I have used: n = 132000 -> corresponds to maxPowerOfTwo = 17, N = 1600
